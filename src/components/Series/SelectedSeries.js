...
const SelectedSeries = ({ item }) => {
  ...
  return (
    <div className='w-[100%] rounded bg-blue-950 flex flex-col md:flex-row justify-between p-4 items-center'>
      <div className='w-[80%] lg:w-[60%] flex flex-col gap-2'>
        ...
        <div className='flex gap-2 items-center'><FaImdb size={24} color='orange' /> <span className='text-amber-500'>{vote_average.toFixed(1)} ({vote_count})</span> </div>
